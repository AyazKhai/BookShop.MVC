...
namespace BookShop.MVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        //private readonly IUserPhoneNumberStore<ShopUser> _userPhoneNumberStore;
        ...
        public class InputModel
        {
            ...
            [RegularExpression(@"^\+?[1-9]\d{1,14}$", ErrorMessage = "Please enter a valid phone number in the format: +7 XXX-XXX-XX-XX.")]
